...
RUN_ROOT="${RUN_ROOT:-/mnt/ssd1/graphmem_v419_gpt54_unified_full_20260803}"
DATA_ROOT="${DATA_ROOT:-/mnt/ssd1/graphmem_v4_0_deepseek_20260730}"
...
echo "Unified GPT-5.4-mini full run complete: ${RUN_ROOT}"
